...
const female=/(female|woman|alona|samantha|karen|moira|tessa|fiona|zira|ava|victoria|susan|hazel|aria|jenny|joanna|kendra|kimberly|amy|emma|olivia|michelle|nicole|salli|ivy|rosa|ana|monica|elena|laura|helena|julie|chloe|alice|amelie|marie|sonia|natasha|veena|raveena|serena)/i;
...
function load(){
  ...
  voices=women.length?women:(nonMale.length?nonMale:available);
  ...
  voices.forEach((v,i)=>voiceSelect.add(new Option('Female voice · '+v.name+' · '+v.lang,String(i))));
